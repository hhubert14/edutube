      ...
      <header className="sticky top-0 z-10 border-b border-zinc-200 bg-white/95 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/95">
        <div className="mx-auto grid h-14 max-w-[1280px] grid-cols-[1fr_minmax(0,560px)_1fr] items-center px-4">
          <button
            type="button"
            onClick={goHome}
            className="col-start-1 flex w-fit shrink-0 cursor-pointer items-center gap-2 text-xl font-semibold tracking-tight text-zinc-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-ytred dark:text-zinc-50"
          >
<svg viewBox="0 0 36 26" className="h-5 w-auto" aria-hidden="true">
          ...
          {showSearch ? (
            <form onSubmit={handleSearch} className="col-start-2 w-full">
          ...
          <a
            ...
            className="col-start-3 justify-self-end rounded-full p-2 text-zinc-500 transition hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-50"
          >
